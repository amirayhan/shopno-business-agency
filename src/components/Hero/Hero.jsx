...
const Hero = () => {
    return (
        <div className="hero w-full pt-20">
            <div className="max-w-[1480px] m-auto grid grid-cols-2 items-center">
                <div className="hero_content ">
                    <span className="px-6 py-3 bg-blue-100 text-blue-600 font-bold rounded-full inline-block">WE ARE EXPERT IN THIS FIELD</span>
                    <h1 className="mt-5">We Help Grow Up Your Business</h1>
